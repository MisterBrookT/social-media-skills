---
name: social-media
description: "中文社交媒体内容生产。触发：公众号文章、小红书笔记/封面/图文、抖音口播/封面、社媒选题、爆款标题、跨平台改写、多平台内容包。"
---

# Social Media

中文社媒内容技能。覆盖公众号、小红书、抖音的文字、封面、图文卡片与跨平台转译。
...
| 公众号 | 标题组、长文、摘要、封面文案、头图方向 | `references/content-patterns.md` |
| 小红书 | 标题、正文、标签、封面大字、图文卡片页纲 | `references/content-patterns.md` + `references/visual-patterns.md` |
| 抖音 | 前 3 秒钩子、口播稿、分镜点、封面标题、话题 | `references/content-patterns.md` |
...
4. 生成平台原生产物：不要把公众号直接缩短成小红书，也不要把小红书正文直接当抖音口播。
